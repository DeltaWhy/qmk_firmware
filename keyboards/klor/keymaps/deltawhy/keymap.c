...
/*
   ...
   ├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤╭────────╮╭────────╮├─────────┼─────────┼─────────┼─────────┼─────────┼─────────┤
   │   CESC  │    Z    │    X    │    C    │    D    │    V    ││ MUTE   ││PLY/PSE ││    K    │    H    │    ,    │    .    │    /    │    :    │
   └─────────┴─────────┴─────────┼─────────┼─────────┼─────────┼╰────────╯╰────────╯┼─────────┼─────────┼─────────┼─────────┴─────────┴─────────┘
                                 │  LOWER  │  SPACE  │   DEL   │         ││         │  ENTER  │  BSPCE  │  RAISE  │
                                 └─────────┴─────────┴─────────┴─────────┘└─────────┴─────────┴─────────┴─────────┘ */

   [_COLEMAK] = LAYOUT_polydactyl(
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
              KC_Q,     KC_W,     KC_F,     KC_P,     KC_B,                          KC_J,     KC_L,     KC_U,     KC_Y,     KC_QUOT,
    KC_TAB,   GUI_A,    ALT_R,    CTL_S,    SHT_T,    KC_G,                          KC_M,     SHT_N,    CTL_E,    ALT_I,    GUI_O,    KC_MINUS,
    CESC,     KC_Z,     ALG_X,    KC_C,     KC_D,     KC_V,     KC_MUTE,   KC_MPLY,  KC_K,     KC_H,     KC_COMM,  ALG_DOT,  KC_SLSH,  KC_COLN,
                                  TT(1),    KC_SPC,   KC_TAB,   KC_NO,     KC_NO,    KC_ENT,   KC_BSPC,  TT(2)
 ),
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    _______,  KC_LGUI,  KC_LALT,  KC_LCTL,  KC_LSFT,  _______,                       KC_MINUS, KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  _______,
    _______,  _______,  KC_RALT,  _______,  _______,  _______,  _______,   _______,  KC_DEL,   KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,   _______,
 ...
 */
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
    ...
    _______,  KC_SCLN,  KC_4,     KC_5,     KC_6,     KC_EQL,                        KC_MINUS, KC_RSFT,  KC_RCTL,  KC_LALT,  KC_RGUI,  _______,
    _______,  KC_GRV,   KC_1,     KC_2,     KC_3,     KC_BSLS,  _______,   _______,  KC_DEL,   _______,  _______,  KC_RALT,  _______,  _______,
 ...
 */
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
              KC_F12,   KC_F7,    KC_F8,    KC_F9,    KC_PSCR,                       HF_TOGG,  _______,  _______,  _______,  _______,
    _______,  KC_F11,   KC_F4,    KC_F5,    KC_F6,    KC_SCRL,                       QWERTY,   KC_RSFT,  KC_RCTL,  KC_LALT,  KC_RGUI,  QK_BOOT,
    _______,  KC_F10,   KC_F1,    KC_F2,    KC_F3,    KC_PAUS,  _______,   _______,  COLEMAK,  _______,  _______,  KC_RALT,  _______,  _______,
                                  _______,  _______,  _______,  _______,   _______,  _______,  _______,  _______
 /*
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
...
// └───────────────────────────────────────────────────────────┘
        ...
        case MAKE_H:
          if (record->event.pressed) {
              ...
              SEND_STRING ("qmk compile -kb klor/2040 -km deltawhy");
            #else
              SEND_STRING ("qmk compile -kb klor -km deltawhy");
            #endif
            tap_code(KC_ENTER);
          }
          break;
